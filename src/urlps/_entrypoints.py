"""Public entry-point functions: parse_url, join, build, and their variants.

This module is the facade layer __init__.py re-exports. Kept separate so
__init__.py stays limited to package setup (version, imports, __all__).
"""
